...
The boot effects dataframe gives me a potential size of the non-invariant effect compared to random, illuminating the items that may not replicate, and my boot summary gives me effect sizes differences between groups 
